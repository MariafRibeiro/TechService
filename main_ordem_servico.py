...
def menu():
    ...
    print("11. Listar ordens em curso")
    print("12. Inserir ordem de serviço")
    print("13. Procurar ordem por ID")
    print("14. Atualizar status")
    print("15. Ver histórico de uma ordem")
    print("0. Sair")
